...
const POINT_PERSON_OPTIONS = ['bride','bridesmaid','groom','groomsman','guest','dj','photographer','venue','mac','scott','gilmor','zhang']
const POINT_PERSON_COLORS = {
  ...
  zhang:        'bg-cyan-50 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300',
